...
export function Login() {
  ...
  async function handleOAuth(provider: Provider) {
    ...
    // On success, Supabase redirects the page — no need to navigate manually
  }
      ...
      <main className='flex items-center justify-center py-24'>
        <Container>
          ...
          >
            ...
            <p className='mt-2 text-sm text-[var(--text-secondary)]'>Welcome back.</p>
            ...
            <p className='mt-6 text-center text-sm text-[var(--text-muted)]'>
              ...
              <Link to='/register' className='text-[var(--azure)] hover:text-[var(--azure-hover)] transition-colors'>
                Create one
              </Link>
            </p>
          </motion.div>
